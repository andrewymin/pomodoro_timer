...
def start_timer():
    ...
    if reps % 8 == 0:
        ...
        messagebox.showinfo(title="Break", message="Take a long break, you need it.")
    elif reps % 2 == 0:
        messagebox.showinfo(title="Break", message="Take a small break.")
        ...
        messagebox.showinfo(title="Work", message="Back to work.")
        count_down(work_sec)
        title_label.config(text="Work", fg=GREEN)
